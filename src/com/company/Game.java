...
public class Game
{
    ...
    public void makeLandscape() {
        ...
        for (int i = 0 ; i < 10; i ++ )
        {
            int randomRowPositionForLake = ((int) (Math.random() * height) + 2);
            // the "set( column , "L")
            int RandomColumForLake = ((int) (Math.random() * width) + 2);

            maze.get(randomRowPositionForLake).set(RandomColumForLake, "L");
        }
        ...
        for (int i = 0 ; i < 5; i ++ )
        {
            int randomRowPositionForHiltops = ((int) (Math.random() * height) + 2);
            // the "set( column , "L")
            int RandomColumForHiltops = ((int) (Math.random() * width) + 2);

            maze.get(randomRowPositionForHiltops).set(RandomColumForHiltops, "H");
        }
    ...
    public void addTreeObject(Tree tree) {
        this.tree = tree;
    }
}
